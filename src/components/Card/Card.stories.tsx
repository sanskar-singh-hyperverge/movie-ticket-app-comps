...
import StarRating from '../StarRating/StarRating'; // Make sure this exists
import '../../index.css';
export default {
  ...
  argTypes: {
    backgroundImages: {
      control: 'array', // For arrays of images or background URLs
    },
    backgroundVideo: {
...
export const CustomCardRowLayout = Template.bind({});
CustomCardRowLayout.args = {
  id: '3',
  backgroundColor: 'bg-blue-500',
  rounded: 'rounded-lg',
  borderStyle: 'border-gray-400',
  flexDirection: 'row',
  className: 'w-96 h-48 justify-start items-center',
  children: (
    <>
...
MovieCard.args = {
  ...
  children: (
    <>
      {/* Movie Title */}
      <h3 className="text-lg font-bold">Kung Fu Panda 4</h3>
...
export const ParentCardWithChildren = Template.bind({});
ParentCardWithChildren.args = {
  id: 'parent-card',
  backgroundColor: 'bg-transparent', // Transparent background
  ...
  children: (
    <>
      ...
      >
        ...
        <p className="text-white t font-semibold">Item 2</p>
      </Card>
